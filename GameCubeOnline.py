...
if __name__ == '__main__':
    # since we're on windows we don't have fork but spawn instead.  
    # spawn is interesting because it starts you now at the top of the program that executed it then forks 
    # this happens on windows machines.
