...
export class PacketSingleton{ 
    ...
    static setPacket(aPacketType){ 
        ...
        this.#myInstance.#myPacket = new aPacketType(); 
    }
    ...
    static setWebSocket(aWebSocketRoute, aPacketIndex){
        ...
        this.#myInstance.#myWebSocket = new WebSocket(aWebSocketRoute);   
    ...
    */
    ...
    static killWebSocket=()=>{ 
        if(!this.#myInstance) this.#myInstance = new PacketSingleton();  
        if (this.#myInstance.#myWebSocket) this.#myInstance.#myWebSocket.close(1000, `Controller #${this.#myInstance.#myCurrentSocketIndex} Connection Killed`); 
    } 
