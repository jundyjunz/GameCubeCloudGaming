...
import { PageLockSingleton } from "/static/Javascript/PageLockSingleton.js"
...
document.addEventListener( "DOMContentLoaded", async (event)=>{ 
    ...
    PageLockSingleton.setMultiToggle((new MultiToggle())
        .setButton((new SwitchButton("SwitchCircleA1")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleA2")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleA3")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleA4")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleA5")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit()));
    PageLockSingleton.setMultiToggle((new MultiToggle())
        .setButton((new SwitchButton("SwitchCircleB1")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleB2")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleB3")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleB4")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleB5")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit()));
    PageLockSingleton.setMultiToggle((new MultiToggle())
        .setButton((new SwitchButton("SwitchCircleC1")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleC2")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleC3")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleC4")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleC5")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit()));
    PageLockSingleton.setMultiToggle((new MultiToggle())
        .setButton((new SwitchButton("SwitchCircleD1")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleD2")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleD3")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleD4")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleD5")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit()));
    PageLockSingleton.setMultiToggle((new MultiToggle())
        .setButton((new SwitchButton("SwitchCircleE1")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleE2")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleE3")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleE4")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit())
        .setButton((new SwitchButton("SwitchCircleE5")).setColorOnMouseOut("gray").setColorOnMouseOver("lightgreen").setInit()));
    PageLockSingleton.setErrorRect((new ErrorBar("PageLockErrorRect"))
        .setColorOnMouseOut("lightcoral")
        .setColorOnMouseOver("red")
        .setTextSettings("Trebuchet MS", 13, "bold", true));
    PageLockSingleton.setGetHashRoute("/get_hash");
    PageLockSingleton.setCheckHashRoute("/check_hash");
    PageLockSingleton.setCookieName("HashCookie");
    PageLockSingleton.setCookieExpiry(60 * 60 * 24 * 7);
    PageLockSingleton.setDestroyClassName(".pagelockoverlay");
    PageLockSingleton.setSubmitButton((new Button("PageLockSubmitCircle"))
        .setColorOnMouseOut("gainsboro")
        .setColorOnMouseOver("lightblue"));
    PageLockSingleton.setInit();


    await PageLockSingleton.checkPageLock(); // the entire js script is in this one async com loaded callback. It will async block this until it is complete.
    ...
    let theErrorBar = InteractiveHtmlElementSingleton.registerElement(
